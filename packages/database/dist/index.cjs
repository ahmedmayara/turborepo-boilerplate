...
${c}`);
      ...
      let u = "debian";
      if (t === "linux" && o === void 0 && ne(`Distro is "${a}". Falling back to Prisma engines built for "${u}".`), t === "darwin" && r === "arm64")
        return "darwin-arm64";
      if (t === "darwin")
        return "darwin";
      if (t === "win32")
...
`);
    ...
    function Di(e, t, r, n) {
      ...
      if (g ? (se(r, 1, Ye), n === void 0 ? n = f.rounding : se(n, 0, 8)) : (r = f.precision, n = f.rounding), !e.isFinite())
        c = Ls(e);
      else {
        ...
        if (!p[0])
          ...
          if (s < 0 ? o-- : (e = new f(e), e.d = p, e.e = o, e = M(e, d, r, n, 0, i), p = e.d, o = e.e, u = Ss), s = p[r], a = i / 2, u = u || p[r + 1] !== void 0, u = n < 4 ? (s !== void 0 || u) && (n === 0 || n === (e.s < 0 ? 3 : 2)) : s > a || s === a && (n === 4 || u || n === 6 && p[r - 1] & 1 || n === (e.s < 0 ? 8 : 7)), p.length = r, u)
            for (; ++p[--r] > i - 1; )
...
${et(e)}`;
    ...
    async function tl(e, t) {
      ...
      if (nm("enginePath", n), n !== void 0 && e === "binary" && pi(n), n !== void 0)
    ...
    var _r = class {
      ...
      async transaction(t, r, n) {
        ...
        if (t === "start") {
          ...
          t === "commit" ? o = await ((_b = this.engine) == null ? void 0 : _b.commitTransaction(n.id, i)) : t === "rollback" && (o = await ((_c2 = this.engine) == null ? void 0 : _c2.rollbackTransaction(n.id, i)));
      ...
      class t {
        ...
        _request(n) {
          ...
          let i = n.middlewareArgsMapper ?? Mm, o = { args: i.requestArgsToMiddlewareArgs(n.args), dataPath: n.dataPath, runInTransaction: !!n.transaction, action: n.action, model: n.model }, s = { middleware: { name: "middleware", middleware: true, attributes: { method: "$use" }, active: false }, operation: { name: "operation", attributes: { method: o.action, model: o.model, name: o.model ? `${o.model}.${o.action}` : o.action } } }, a = -1, l = async (u) => {
            ...
            if (c)
              return this._tracingHelper.runInChildSpan(s.middleware, (O) => c(u, (P) => (O == null ? void 0 : O.end(), l(P))));
...
var require_client = __commonJS({
  "generated/client/index.js"(exports2) {
    ...
    exports2.Prisma.TaskOrderByRelevanceFieldEnum = {
      id: "id",
      title: "title",
      description: "description"
    };
    ...
    var config2 = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\MSI\\Desktop\\my-turborepo\\packages\\database\\generated\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\Users\\MSI\\Desktop\\my-turborepo\\packages\\database\\prisma\\schema.prisma",
        "isCustomOutput": true
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
      ...
      "inlineSchemaHash": "1ef10cb7c1397d9c3b6296d40dda9a52e1b7f1c66dd4c18042728b52b97784a9",
      "copyEngine": true
    };
    var fs = require("fs");
...
__reExport(src_exports, __toESM(require_client(), 1), module.exports);
